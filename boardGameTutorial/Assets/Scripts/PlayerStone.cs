    ...
    void Update()
    {
                ...
                targetPosition) < smoothDistance) 
        {
            ...
            if ((moveQueue == null || moveQueueIndex == (moveQueue.Length))  && ((this.transform.position.y-smoothDistance)>targetPosition.y))
            {
                if (this.scored == false) // If we haven't scored, we have to go down on our tile
                {
                    ...
                    */
                    this.transform.position = new Vector3(this.transform.position.x, targetPosition.y, this.transform.position.z);
        ...
        else if (this.transform.position.y < (smoothHeight - smoothDistance))
        {
            ...
            this.transform.position = Vector3.SmoothDamp(
                ...
                smoothTimeVertical/animationSpeed);
             * */
            this.transform.position = new Vector3(this.transform.position.x, smoothHeight, this.transform.position.z);
        }
        ...
        {   
             ...
             * */
            this.transform.position = new Vector3(targetPosition.x, smoothHeight, targetPosition.z);
        }
    }
